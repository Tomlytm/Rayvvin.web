<template>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="d-flex align-items-center">
                ...
                <!-- <h3 v-show="!merchantStripeOnboarding.completedProcess" class="text-danger">Onboarding not completed</h3> -->
            </div>
            <div>
                            ...
                            <div data-simplebar style="height: 250px;">
                                <ul class="list-group list-group-flush notification-list-scroll fs-6">
                                    <li class="list-group-item px-5 py-4 list-group-item-action active">
                                        <a href="#!" class="text-muted">
                                            <div class="d-flex">
                                           <img src="/assets/imagesavatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle ">
                                           <div class="ms-4">
                                           <p class="mb-1">
                                    ...
                                    <li class="list-group-item  px-5 py-4 list-group-item-action">
                                        <a href="#!" class="text-muted">
                                            <div class="d-flex">
                                           <img src="/assets/imagesavatar/avatar-5.jpg" alt="" class="avatar avatar-md rounded-circle ">
                                           <div class="ms-4">
                                           <p class="mb-1">
                                    ...
                                    <li class="list-group-item px-5 py-4 list-group-item-action">
                                        <a href="#!" class="text-muted">
                                            <div class="d-flex">
                                           <img src="/assets/imagesavatar/avatar-2.jpg" alt="" class="avatar avatar-md rounded-circle ">
                                           <div class="ms-4">
                                           <p class="mb-1">
    ...
    <div class="modal fade" ref="completeRegModal" id="completeRegModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="completeRegModal" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-4">
          <div class="modal-header border-0">
            <h5 class="modal-title fs-3 fw-bold" id="completeRegModalLabel">Complete your onboarding</h5><br />
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
                <p>We have partnered with <a href="https://www.stripe.com">Stripe</a> for secure payments to our merchants. Complete your onboaring on Stripe to enable your account receive payments securely</p>
            <a :href="merchantStripeOnboarding.stripeOnboardingLink" class="btn btn-primary">Help me finish my onboarding</a>
          </div>
...
export default {
    ...
    computed: {
        ...
        merchantStripeOnboarding() {
            return this.$store.getters.merchantStripeOnboarding
        }
    },
    async created() {
        const result = await this.$store.dispatch('checkMerchantHasCompletedStripeOnboarding');
        
        if (!result && this.$route.path === '/shop') {
            return $('#completeRegModal').modal('show')
        }
    },
    mounted() {
    },
