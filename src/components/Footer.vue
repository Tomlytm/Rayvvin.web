<template>
    <footer class="footer bg-white mont">
<div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 mt-4 mt-md-0">
        <ul class="list-inline mb-0 text-lg-end text-center">
          <li class="list-inline-item mb-2 mb-md-0 text-dark">Coming soon to your favourite stores.</li>
  ...
  <div class="border-top py-4">
    <div class="row align-items-center">
      <div class="col-md-6"><span class="small text-muted">© 2023 <span id="copyright"> -
        {{ new Date() }}
        <!-- <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script> -->
    </span>All rights reserved. Powered by <a href="https://www.makowictsolutions.com">Makow ICT Solutions</a>.</span></div>
      <div class="col-md-6">
